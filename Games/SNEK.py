...
class Snake():
    ...
    def update(self, surface):
        ...
        if ticks > self.old_time + step_time: #modified code
            self.old_time = ticks
            #move body segments
            for n in range(len(self.segments)-1, 0, -1): #makes them follow
...
def get_current_direction():
    ...
    elif head_x+1 == first_segment_y: return "up"
...
def game_init():
    global screen, backbuffer, font, timer, snake, food_group, food1_group
