...
def game_init():
    global screen, backbuffer, font, timer, snake, food_group, snake1, oneplayer, twoplayer, timer1
    oneplayer = False
    twoplayer = False
    pygame.init()
...
while True:
    ...
    if oneplayer:
        ...
        print_text(font, 0, 40, "P1 Streak: " + str(streak))
        print_text(font, 0, 60, "P2 Streak: " + str(streak))
    ...
    if collide:
        print_text(font, 450, 250, "Press R to Reset")
        print_text(font, 400, 350, "Press 1 to Play 1 PLayer")    
        print_text(font, 400, 450, "Press 2 to Play 1 PLayer")
